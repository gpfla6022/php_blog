...
$meta['siteName'] = "coderscode BLOG";
$meta['siteCanonicalUrl'] = $_SERVER['REQUEST_URI'];
$meta['siteKeywords'] = "IT, Java, PHP, HTML, CSS, Javascript, MySQL, Linux, Spring, Git, Python";
...
if ( !isset($meta['siteSubject']) ) {
  $meta['siteSubject'] = "IT 블로그 플랫폼, coderscode BLOG";
}

if ( !isset($meta['siteDescription']) ) {
  $meta['siteDescription'] = "IT 블로그 플랫폼, coderscode BLOG 입니다. 누구나 멋진 나만의 IT 블로그를 만들 수 있습니다.";
}
