...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-C4Z6MZ0SMK"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-C4Z6MZ0SMK');
  </script>
    <?php } ?>
...
<div class="site-wrap min-h-screen flex flex-col pt-10">
    <header class="top-bar fixed top-0 inset-x-0 h-10 top-bar-head-color">
      <div class="container mx-auto h-full flex">
        <a href="/" class="top-bar__logo px-5 flex items-center">
          <span><i class="fas fa-angle-left"></i></span>
          <span class="ml-2 font-bold hidden sm:inline">CODERS CODE&nbsp;</span>
